...
$url        = 'http://dforest.watch.impress.co.jp/library/m/mery/11013/MerySetup-2.6.7.exe' # download url, HTTPS preferred
$url64      = 'http://dforest.watch.impress.co.jp/library/m/mery/11901/MerySetup-x64-2.6.7.exe' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
...
$packageArgs = @{
  ...
  softwareName  = 'mery*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique

  # Checksums are now required as of 0.10.0.
  # To determine checksums, you can get that from the original site if provided. 
  # You can also use checksum.exe (choco install checksum) and use it 
  # e.g. checksum -t sha256 -f path\to\file
  checksum      = 'ec846a649a6cc7c6299dda2a8de1c15288069e70ecb609daff23c76b6dcebcb3'
  checksumType  = 'sha256' #default is md5, can also be sha1, sha256 or sha512
  checksum64    = 'a6007e341a0dd9485308f7c01a37217b03254249d467dde85b13d075216b9229'
